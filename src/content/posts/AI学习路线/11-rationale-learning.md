...
$$\mathcal L=\mathcal L_{task}+\lambda_1\|z\|_1+
\lambda_2\sum_t|z_t-z_{t-1}|$$
...
FedGR 在联邦图学习中加入 anti-shortcut augmentations，在各客户端制造与本地捷径冲突的样本，学习更稳定的 rationale，再聚合模型。评测要同时看预测性能、解释质量、客户端差异与通信成本。
...
- [FedGR（ICML 2024）](https://openreview.net/forum?id=ZxDqSBgFSM)
